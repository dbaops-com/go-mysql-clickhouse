#SQL1: 配置文件关键信息生成SQL
SELECT 
    concat('SQLType,BinlogTime,ParseTime,ServerId,BinlogXid, ',group_concat(column_name ORDER BY ORDINAL_POSITION ASC)),
    ...
    ', SQLType String, BinlogTime String, ServerId String, ParseTime UInt64, BinlogXid String) 
